...
::: {.page .cover}
![](images/head-irad-dead-crossing-cabin-cube-video.png){.bg}
...
::: {.page .textpage}
::: {.overlay .textcopy}
Reframing the imaginary landscapes of the West.

The structure resembles a physicalized wireframe model: a cabin stripped of its protections, exposed from all sides.
...
::: {.page .imagepage}
![](images/playable-cinema-cowpoke-cabin-back-view.jpg){.bg}
...
::: {.page .imagepage}
![](images/playable-cinema-cowpoke-controller-bar.jpg){.bg}
...
::: {.page .imagepage}
![](images/head-irad-cowpoke-controller-front-2025-11-03.png){.bg}
...
::: {.page .imagepage}
![](images/head-irad-dead-crossing-cabin-instllation-overhead-view-web.jpg){.bg}
