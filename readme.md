...
An exhibition document explaining the installation Dead Crossing can be found here: [dead-crossing-exhibition-document](https://github.com/abstractmachine/head-irad-playable-cinema/releases/tag/dead-crossing-exhibition-document) (PDF)
